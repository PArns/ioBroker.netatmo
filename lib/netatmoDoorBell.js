module.exports = function (myapi, myadapter) {
    ...
    async function handleDoorbell(aDoorbell, aHome) {
        ...
        if (aDoorbell.sd_status) {
            ...
            await adapter.setStateAsync(infoPath + '.sd_status', {val: aDoorbell.sd_status, ack: true});
        }
        ...
        if (aDoorbell.alim_status) {
            ...
            await adapter.setStateAsync(infoPath + '.alim_status', {val: aDoorbell.alim_status, ack: true});
        }
